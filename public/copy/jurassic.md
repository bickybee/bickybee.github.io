# The Project
 I was a **Gameplay Programmer** on Jurassic World: Primal Ops, an action-adventure, dinosaur-collecting mobile game built for Universal. I was part of the team for nearly the entire duration of the project, shipping the game in 2022 and staying on for a few months of live-ops as well.

*[**Click here to check out the launch trailer on YouTube!**](https://www.youtube.com/watch?v=XhM6s8E9IAk)*

Though the project has since been cancelled, it entertained tons of loyal fans during its run. Popular YouTube channels like [**The Gaming Beaver**](https://youtu.be/4gNaxBiWDhw?si=HZ2DxsNUgDSp2czh) posted gameplay videos regularly.

# Contributing Across the Stack

My main contributions were in the meta-game, collaborating closely with both Game Designers and UI Designers to implement data-driven gameplay features across the stack. Here are some of the major systems that I owned and developed.
...
- Made significant contributions to the FTUE (first time user experience) system.
- Built the toaster notification system used throughout the game.
- Built the universal back-button / back-stack used throughout the game UI.
